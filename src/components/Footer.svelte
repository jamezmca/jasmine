...
>
    ...
    >
        <div class="flex flex-col gap-4">
            <h1 class="text-6xl md:text-7xl font-semibold text-center">
                Meet <span class="poppins text-emerald-400 ">Jasmine</span>
            </h1>
            <div class="grid place-items-center p-8">

                <div class="grid place-items-center rounded-full overflow-hidden">
